...
create index if not exists client_favorites_profile_id_idx
on public.client_favorites (profile_id);

alter table public.client_favorites enable row level security;

drop policy if exists "Users can read own favorites" on public.client_favorites;
