...
function getOperatorStatusButtonClass(status: string) {
  if (status === 'ONLINE_NOW') return 'er-glass-btn--green';
  if (status === 'AVAILABLE_TODAY') return 'er-glass-btn--green';
  if (status === 'BUSY' || status === 'APPOINTMENT_ONLY') return 'er-glass-btn--orange';
  if (status === 'TRAVELING') return 'er-glass-btn--orange';
  return 'er-glass-btn--gray';
}
